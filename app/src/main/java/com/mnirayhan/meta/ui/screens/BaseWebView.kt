package com.mnirayhan.meta.ui.screens
...
import com.mnirayhan.meta.ui.NobookViewModel
import com.mnirayhan.meta.ui.components.NetworkErrorDialog
import com.mnirayhan.meta.ui.components.sheet.NobookSheet
import com.mnirayhan.meta.utils.ExternalRequestInterceptor
import com.mnirayhan.meta.utils.fileChooserWebViewParams
import com.mnirayhan.meta.utils.isAutoDesktop
import com.mnirayhan.meta.utils.jsBridge.DownloadBridge
import com.mnirayhan.meta.utils.jsBridge.NavigateFB
import com.mnirayhan.meta.utils.jsBridge.NobookSettings
import com.mnirayhan.meta.utils.jsBridge.ThemeChange
...
fun BaseWebView(
    ...
    // Navigate to Meta on fb logo pressed from messenger.
    ...
    // A possible overkill to fix https://github.com/mnirayhan/Meta/issues/5
