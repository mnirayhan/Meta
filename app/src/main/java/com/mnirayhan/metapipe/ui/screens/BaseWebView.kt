package com.mnirayhan.metapipe.ui.screens
...
import com.mnirayhan.metapipe.ui.NobookViewModel
import com.mnirayhan.metapipe.ui.components.NetworkErrorDialog
import com.mnirayhan.metapipe.ui.components.sheet.NobookSheet
import com.mnirayhan.metapipe.utils.ExternalRequestInterceptor
import com.mnirayhan.metapipe.utils.fileChooserWebViewParams
import com.mnirayhan.metapipe.utils.isAutoDesktop
import com.mnirayhan.metapipe.utils.jsBridge.DownloadBridge
import com.mnirayhan.metapipe.utils.jsBridge.NavigateFB
import com.mnirayhan.metapipe.utils.jsBridge.NobookSettings
import com.mnirayhan.metapipe.utils.jsBridge.ThemeChange
...
fun BaseWebView(
    ...
    // Navigate to MetaPipe on fb logo pressed from messenger.
    ...
    // A possible overkill to fix https://github.com/mnirayhan/MetaPipe/issues/5
