...
import com.mnirayhan.metapipe.R
import com.mnirayhan.metapipe.ui.NobookViewModel
import com.mnirayhan.metapipe.utils.Script
import com.mnirayhan.metapipe.utils.fetchScripts
...
fun FacebookWebView(
    ...
    BaseWebView(
        ...
        viewModel = viewModel,
        onPostLoad = {
            val cdnBase = "https://raw.githubusercontent.com/mnirayhan/MetaPipe/refs/heads/main/app/src/main/res/raw"
