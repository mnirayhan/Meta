...
import com.mnirayhan.meta.R
import com.mnirayhan.meta.ui.NobookViewModel
import com.mnirayhan.meta.utils.Script
import com.mnirayhan.meta.utils.fetchScripts
...
fun FacebookWebView(
    ...
    BaseWebView(
        ...
        viewModel = viewModel,
        onPostLoad = {
            val cdnBase = "https://raw.githubusercontent.com/mnirayhan/Meta/refs/heads/main/app/src/main/res/raw"
